...
// import { DogadjajType } from '../types';
    ...
    return (
        ...
        <HomePageNavbar />
                <div className="container silver1 p-4">
                    ...
                    <div className="col text-center text-md-start p-4 p-md-0">
        ...
        <div className="container mt-5 pt-1">
            <h2 className="holder-header d-inline-block mb-3">Informacije:</h2>
            <div className="silver1 p-4">
            <div className="m-2">Adresa: Obrenovićeva 20, Niš</div>
            <div className="m-2">
                Dozvoljeno pušenje:
                Da </div>
                <br />
