...
export default function ListaKlubova() {
  ...
  const handleSubmit = (e: any) => {
    ...
    axios
      .post(
        ApiConfig.BASE_URL +
          `/Klub/DodajKlub/${klubData.idOrganizatora}/${klubData.naziv}/${klubData.lokacija}/${klubData.brojStolovaBS}/${klubData.brojStolovaVS}/${klubData.brojStolovaS}`,
        formData
      )
      .then((response) => {
  ...
  const getData = () => {
    axios
      .get(ApiConfig.BASE_URL + "/Klub/VratiKlubove")
