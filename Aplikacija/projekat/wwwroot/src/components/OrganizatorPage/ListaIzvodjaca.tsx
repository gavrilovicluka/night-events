  ...
  return (
    <>
        ...
        <Modal.Body>
          ...
          >
            ...
            {dostupniDogadjaji.map((dogadjaj) => {
              ...
              if (
                selectedIzvodjac?.termini === null ||
                selectedIzvodjac?.termini === undefined
              )
                return;

              const izvodjacTermini = selectedIzvodjac?.termini.filter(
                (termin: TerminType) =>
                  termin.termin === dogadjaj.datum &&
      ...
      <Modal show={showMessage} onHide={handleCloseMessage}>
        ...
        <Modal.Body>
          <p>Muzicki izvodjac je uspesno angazovan za dogadjaj.</p>
        </Modal.Body>
        <Modal.Footer>
